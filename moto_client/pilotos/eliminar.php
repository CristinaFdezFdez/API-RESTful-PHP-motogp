            ...
            if (isset($_GET["CodPiloto"])) {
                ...
                if (isset($_GET["confirmar"]) && $_GET["confirmar"] == "true") {
                    ...
                    if (isset($resultado->deleted) && $resultado->deleted == "true") {
                        echo "El piloto $id ha sido eliminado";
            ?>
                        <br>
                        <a href="pilotos.php">Volver</a>
                    <?php
                    } else {
                        echo "ERROR: No se puede borrar el piloto $id porque no existe";
                    ?>
                        <br>
                        <a href="pilotos.php">Volver</a>
            <?php
                    ...
                    echo "¿Estás seguro de que deseas eliminar el piloto $id?";
                    echo "<br>";
                    echo "<a href='eliminar.php?CodPiloto=$id&confirmar=true'>Sí, estoy seguro</a>";
                    echo "<br>";
                    echo "<a href='pilotos.php'>No, volver a la página anterior</a>";
                }
            } else {
                echo "ERROR: Falta el parámetro CodPiloto";
            }
            ?>
        </div>
