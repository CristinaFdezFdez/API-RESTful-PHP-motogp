...
<section>
    ...
    <div class="container">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            curl_close($ch);
            $equipo = json_decode($server_output);
            // Una vez que hemos insertado el equipo incluimos otro fichero que muestra el equipo creado
            $_GET["CodEquipo"] = $equipo->CodEquipo;
        ...
        ?>
            <form method="post">
                ...
                <input type="text" id="NomEquipo" name="NomEquipo">
                <br>
                <label for="AnnoFundacion">Año de Fundación:</label>
                <input type="AnnoFundacion" id="AnnoFundacion" min="1900" name="AnnoFundacion">

                <br>
                <label for="PaisEquipo">País del equipo:</label>
                <select id="PaisEquipo" name="PaisEquipo">
