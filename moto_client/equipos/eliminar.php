...
<div class="container">
    ...
    if (isset($_GET["CodEquipo"])) {
        ...
        if (isset($_GET["confirmar"]) && $_GET["confirmar"] == "true") {
            // El usuario ha confirmado, eliminar
            $ch = curl_init();
            ...
            if (isset($resultado->deleted) && $resultado->deleted == "true") {
                echo "El equipo $id ha sido eliminado"; ?>
                <br>
                <a href="equipos.php">Volver</a>
            <?php
            } else {
                echo "ERROR: No se puede borrar el equipo $id porque no existe";
            ?>
                <br>
                <a href="equipos.php">Volver</a>
    <?php
            ...
            echo "¿Estás seguro de que deseas eliminar el equipo $id?";
            echo "<br>";
            echo "<a href='eliminar.php?CodEquipo=$id&confirmar=true'>Sí, estoy seguro</a>";
            echo "<br>";
            echo "<a href='equipos.php'>No, volver a la página anterior</a>";
        }
    } else {
        echo "ERROR: Falta el parámetro CodEquipo";
    }
    ?>
